...
#Read files
trees=read.tree("desmo161_381loci_trim_names_Pisgah3.trees")
Tx=read.table("desmo161_381loci_trim_names_Pisgah.csv")  
...
n=64 #Possible label combinations
r=sample(1:(dim(combinations)[1]),n)
for(i in 1:n)
{ 
...
save(TREES , file=paste0("AHE_data.RData"))
