...
#load trees obtained in file 'Sample_trees_AHE.R' 
trees=read.tree("AHE_data.phylo") 
...
pTable  = quartetTableParallel( trees,taxonnames =taxa,numCores=15) #this lines takes 372.3 minutes with 15 cores.
...
Deep=Quartet_Analysis(Sa, pvalue= 1e-80);
Deep
